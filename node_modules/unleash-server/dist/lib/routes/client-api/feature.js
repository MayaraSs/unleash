...
class FeatureController extends Controller {
    constructor({ featureToggleService }, { getLogger, experimental }) {
        ...
        if (experimental && experimental.clientFeatureMemoize) {
            ...
            this.cachedFeatures = memoizee((query, fields) => this.toggleService.getFeatures(query, fields), {
                promise: true,
    ...
    async getAll(req, res) {
        try {
            let features;
            if (this.cache) {
                features = await this.cachedFeatures(req.query, FEATURE_COLUMNS_CLIENT);
            }
            else {
                features = await this.toggleService.getFeatures(req.query, FEATURE_COLUMNS_CLIENT);
            }
