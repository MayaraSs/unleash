...
const { DELETE_STRATEGY, CREATE_STRATEGY, UPDATE_STRATEGY, } = require('../../types/permissions');
const version = 1;
class StrategyController extends Controller {
    constructor(config, { strategyService }) {
        ...
        this.post('/:strategyName/deprecate', this.deprecateStrategy, UPDATE_STRATEGY);
        this.post('/:strategyName/reactivate', this.reactivateStrategy, UPDATE_STRATEGY);
    }
