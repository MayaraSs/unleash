...
class Controller {
    ...
    post(path, handler, permission, ...acceptedContentTypes) {
        this.app.post(path, checkPermission(permission), requireContentType(...acceptedContentTypes), handler.bind(this));
    }
    put(path, handler, permission, ...acceptedContentTypes) {
        this.app.put(path, checkPermission(permission), requireContentType(...acceptedContentTypes), handler.bind(this));
    }
    ...
    fileupload(path, filehandler, handler, permission) {
        this.app.post(path, checkPermission(permission), filehandler.bind(this), handler.bind(this));
    }
