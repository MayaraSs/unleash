...
test('yields current versions', async () => {
    ...
    fetchMock.mock({ url: testurl, method: 'POST' }, {
        latest: false,
        versions: latest,
    });
    const service = new VersionService({ settingStore }, { getLogger, versionCheck: { url: testurl, enable: true } });
...
test('supports setting enterprise version as well', async () => {
    ...
    const service = new VersionService({ settingStore }, {
        getLogger,
