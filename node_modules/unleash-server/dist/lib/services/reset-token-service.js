...
class ResetTokenService {
    constructor(stores, { getLogger, server }) {
    ...
    async createToken(tokenUser, creator, expiryDelta = ONE_DAY) {
    ...
    generateToken() {
        return bcrypt_1.default.hash(crypto_1.default.randomBytes(32), 10);
    }
}
