...
module.exports = {
  ...
  "timestamp": "{{event.data.createdAt}}"
            ...
            description: "(Optional) You may format the body using a mustache template. If you don't specify anything, the format will similar to the events format (https://docs.getunleash.io/docs/api/admin/events)",
            type: 'textfield',
            required: false,
        },
    ],
