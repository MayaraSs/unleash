...
test('returns list of feature toggles', async () => app.request
...
test('can untag feature', async () => {
    ...
    await app.request
        ...
        .expect(201);
    await app.request
        .delete(`/api/admin/features/${feature1Name}/tags/${tag.type}/${tag.value}`)
        .expect(200);
    return app.request
...
test('Can query for multiple tags using OR', async () => {
    ...
    await app.request
        ...
        .expect(201);
    return app.request
        .get(`/api/admin/features?tag[]=${tag.type}:${tag.value}&tag[]=${tag2.type}:${tag2.value}`)
        .expect('Content-Type', /json/)
        .expect(200)
        .expect(res => {
